...
- beta2 remains a pre-release, not latest. The first candidate's natural
  ...
  seconds, original service/TUN). Field results belong in `docs/archive/2026-09/LEGACY_BETA_PLAN.md`, never
...
Tracked step by step in `docs/archive/2026-09/IMS_NAMING_PHASE2_PLAN.md`. Phase 1 kept every
